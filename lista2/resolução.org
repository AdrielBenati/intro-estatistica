...
#+begin_src R :results output :exports both :tangle 4.r
...
#+begin_src R :results output :exports results :tangle 13.r
...
#+begin_src R :results output :exports both :tangle 19a.r
...
#+begin_src R :results output :exports both :tangle 19b.r
  dist <- c(1.8, 2.5, 0.4, 1.9, 4.4, 2.2, 3.5, 0.2, 0.9, 1.4, 1.1,
  1.7, 1.2, 2.3, 1.9, 0.8, 1.5, 1.7, 1.4, 2.1, 3.2, 15.1, 2.1, 1.4,
  0.5, 0.9, 1.7, 0.5, 0.8, 3.7, 1.4, 1.8, 2.0, 1.1, 1.0, 0.8)
...
#+begin_src R :file boxplot.png :results output graphics file :exports both :tangle 19c.r
